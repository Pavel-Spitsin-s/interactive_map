...
while run:
    if f2:
        for event in pygame.event.get():
            ...
            text = font.render("Российской Федерации принадлежат 4 космодрома.", True, (240, 240, 240))
            screen.blit(text, (90, 0))

            text = font.render("Три из них находятся на территории России: Капустин Яр, Восточный и Ясный.", True,
                               (240, 240, 240))
            screen.blit(text, (30, 15))

            text = font.render("Четвертый космодром - Байконур находится на территории Казахстана.", True,
                               (240, 240, 240))
            screen.blit(text, (55, 30))

            text = font.render("Для отображения интерактивной карты космодрома введите его координаты", True,
                               (240, 240, 240))
            screen.blit(text, (30, 45))

            text = font.render("Капустин яр - 45.76, 48.57", True,
                               (240, 240, 240))
            screen.blit(text, (0, 60))

            text = font.render("Байконур - 63.31, 45.62", True,
                               (240, 240, 240))
            screen.blit(text, (0, 75))

            text = font.render("Восточный - 128.334405, 51.884058", True,
                               (240, 240, 240))
            screen.blit(text, (0, 90))

            text = font.render("Ясный - 59.850274, 51.049437", True,
                               (240, 240, 240))
            screen.blit(text, (0, 105))

            text = font.render("Введите координаты:" + m, True, (240, 240, 240))
